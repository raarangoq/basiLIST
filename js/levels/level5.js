...
level5 = {
	create: function() {
		...
		// el Fondo
		level = game.add.sprite(0, 0, 'level5-ground');
	...
	text = game.add.text(20, 20, 'inicio', { fontSize: '32px', fill: '#FFF'});
	text.fixedToCamera = true;
	texta = game.add.text(20, 60, 'inicio', { fontSize: '32px', fill: '#FFF'});
	texta.fixedToCamera = true;
		...
		// Se agrega la cuarta serpiente del nivel
		snakeHeads[3] = addSnakeSegment('');
		snakeHeads[3].addSegment();
		snakeHeads[3].addSegment();
		snakeHeads[3].addSegment();
		snakeHeads[3].addSegment();
		snakeHeads[3].addSegment();
	...
	text.text = game.global.is_playing;
	},
	...
	addWalls: function(){	
		...
		var wall = level.walls.create(0, 550, 'level5-footwall');
		wall.body.immovable = true;
		wall = level.walls.create(0, 0, 'level5-upperwall');
		wall.body.immovable = true;
		wall.body.setSize(800, 85, 0, 0);
		wall = level.walls.create(0, 0, 'level5-lateralwall');
		wall.body.immovable = true;
		wall = level.walls.create(740, 0, 'level5-lateralwall2');
		wall.body.immovable = true;
	},
